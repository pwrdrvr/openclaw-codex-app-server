> **Archived.** This is the README as it stood while the plugin was maintained,
> kept for anyone still running it. The project is defunct — see the
> [current README](../README.md) for what to use instead.
>
> Compatibility notes below stop at OpenClaw `2026.4.5` and will not be updated.
